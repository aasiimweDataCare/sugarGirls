...
echo form_open('DashboardController/update', 'role="form"'); ?>
  ...
  <button type="button" onclick="location.href='<?php echo site_url('DashboardController') ?>'" class="btn btn-success">Back</button>
</form>
<?php echo form_close(); ?>