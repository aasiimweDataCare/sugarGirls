    ...
    <div id="page-wrapper">
                                ...
                                <ul class="nav navbar-nav navbar-kiri" id="bottom_menu">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu menu-top-front" role="menu">
                                            <li><a href="indicator_tables.php">Tracking Table</a></li>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i><strong> Indicator Definitions</strong>
                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                    <th rowspan="2"># Indicator Number</th>
                                    <th rowspan="2">Indicator</th>
                                    <th colspan="5">Data Sources</th>
                                ...
                                <tr>
                                    <td>6</td>
                                    <td>Number of farmers benefiting directly from Activity interventions</td>
            ...
            <div class="col-lg-4">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-bell fa-fw"></i> <strong>Indicator Data Sources</strong>
                    </div>
                    <!-- /.panel-heading -->
                    <div class="panel-body">
                        FORM 7
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-bell fa-fw"></i> <strong>Indicator Formula Applied</strong>
                    </div>
                    <!-- /.panel-heading -->
                    <div class="panel-body">
